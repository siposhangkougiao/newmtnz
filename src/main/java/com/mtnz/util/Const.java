...
public class Const {
	...
	public static final String SEND_POINT = "admin/config/SEND_POINT.txt"; // 赠送积分路径
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(ueditor)|(uploadFiles)|(main)|(websocket)).*"; // 不对匹配该值的访问路径拦截（正则）
